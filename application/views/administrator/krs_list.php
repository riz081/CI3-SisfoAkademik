<div class="container-fluid">
	...
	<div class="alert alert-success" role="alert">
  	...
  	<?php echo anchor('administrator/krs/tambah_krs/'.$nim.'/'.$id_thn_akad,'<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"></i> Tambah Data</button>') ?>

  	<?php echo anchor('administrator/krs/print','<button class="btn btn-sm btn-warning mb-3"><i class="fas fa-print fa-sm"></i> Print</button>') ?>
